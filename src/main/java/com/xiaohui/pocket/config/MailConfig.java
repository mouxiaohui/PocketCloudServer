...
public class MailConfig {
    ...
    public JavaMailSender javaMailSender() {
        ...
        properties.put("mail.smtp.ssl.enable", mailProperties.getProperties().getSmtp().getSsl().isEnable());
        properties.put("mail.smtp.socketFactory.class", mailProperties.getProperties().getSmtp().getSocketFactory());
